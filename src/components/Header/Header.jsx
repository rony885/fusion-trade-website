...
//               techguru That Ensures Your IT Runs Seamlessly, Anytime and Every
//               Time
//             </p>
...
//                 <div className="text">
//                   <p>
//                     <Link to="tel:1212345678900">+12 (123) 456 78900</Link>
//                   </p>
//                 </div>
//               </li>
//             </ul>
...
//                   <li className="megamenu current" onClick={closeMenu}>
//                     <Link to="/">Home</Link>
//                   </li>
